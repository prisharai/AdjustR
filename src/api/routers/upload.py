...
from src.utils.file_validation import validate_file_extension, validate_file_size, is_video_file, is_image_file
...
async def upload_file(
    ...
    try:
        ...
        from src.api.background_tasks import process_video_task
...
async def list_videos(
    ...
    """
    from src.db.models import Inference
